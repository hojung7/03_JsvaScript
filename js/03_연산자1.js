 ...
 */
  ...
  function allOperationsFn(){
    ...
    const v2 = Number(in2.value); // 두 번쩨 깂
...
console.log("num++", num++); //  101출력 -> num1증가(102)
console.log("num++", num++); //  102출력 -> num1증가(103)
